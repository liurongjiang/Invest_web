$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data){          //data就是返回的json类型的数据
          ...
          project_info += '<tr><td rowspan="3" width="15%"><img src="'+ obj.logo +'></td><td width="15%" ><h3>'+ obj.project_name +'</h3></td><td width="20%" >'+ obj.platform_desc +'</td><td width="15%">'+ obj.city +'</td><td width="15%"></td><td width="10%"></td></tr>';
